...
spinWheelFieldBtn.reset(new frc::JoystickButton(operatorJoystick.get(), 1));
spinWheelFieldBtn->WhenPressed(new SpinWheelField());
spinWheelRightBtn.reset(new frc::JoystickButton(operatorJoystick.get(), 1));
spinWheelRightBtn->WhileHeld(new SpinWheel(0.5));
spinWheelLeftBtn.reset(new frc::JoystickButton(operatorJoystick.get(), 1));
spinWheelLeftBtn->WhileHeld(new SpinWheel(-.5));
spitFuelBtn.reset(new frc::JoystickButton(operatorJoystick.get(), 1));
spitFuelBtn->WhileHeld(new FuelGrab(-0.5));
suckFuelBtn.reset(new frc::JoystickButton(operatorJoystick.get(), 1));
suckFuelBtn->WhileHeld(new FuelGrab(0.5));
toggleTractorBeamBtn.reset(new frc::JoystickButton(operatorJoystick.get(), 1));
...
ejectFuelBtn.reset(new frc::JoystickButton(operatorJoystick.get(), 1));
ejectFuelBtn->WhenPressed(new Eject());
aimDownBtn.reset(new frc::JoystickButton(operatorJoystick.get(), 1));
aimDownBtn->WhileHeld(new AimDown());
aimUpBtn.reset(new frc::JoystickButton(operatorJoystick.get(), 1));
aimUpBtn->WhileHeld(new AimUp());
aimRightBtn.reset(new frc::JoystickButton(operatorJoystick.get(), 1));
aimRightBtn->WhileHeld(new AimRight());
aimLeftBtn.reset(new frc::JoystickButton(operatorJoystick.get(), 1));
aimLeftBtn->WhileHeld(new AimLeft());
driverJoystick.reset(new frc::Joystick(0));

gravitateDownBtn.reset(new frc::JoystickButton(driverJoystick.get(), 1));
gravitateDownBtn->WhileHeld(new Gravitate(-0.5));
gravitateUpBtn.reset(new frc::JoystickButton(driverJoystick.get(), 1));
