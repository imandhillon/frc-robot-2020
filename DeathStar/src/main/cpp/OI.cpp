...
spitFuelBtn.reset(new frc::JoystickButton(driverJoystick.get(), 1));
spitFuelBtn->WhileHeld(new FuelGrab(-0.5));
suckFuelBtn.reset(new frc::JoystickButton(driverJoystick.get(), 2));
suckFuelBtn->WhileHeld(new FuelGrab(0.5));
toggleTractorBeamBtn.reset(new frc::JoystickButton(driverJoystick.get(), 3));
toggleTractorBeamBtn->WhenPressed(new ToggleTractorBeam());
