...
std::shared_ptr<IonCannon> Robot::ionCannon;
...
std::shared_ptr<LimeAide> Robot::limeAide;
...
void Robot::RobotInit() {
	...
	limeAide.reset(new LimeAide());
	SPAMutil::Log("Robot", "Constructed LimeAide", SPAMutil::LOG_DBG);
	...
	// moved to subsystem:  warpDriveInverter -> ColorMatcherInit();
}
