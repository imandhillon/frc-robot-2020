...
void LifeSupport::Periodic() {
    ...
    //     std::make_pair("colorWhenTrue", "green"),
    //     std::make_pair("colorWhenFalse", "maroon")
    // };
    bool tst = false;


    // frc::Shuffleboard::GetTab("Test").Add("TargetInView", true)
    //     .WithWidget(frc::BuiltInWidgets::kBooleanBox).GetEntry();
    //     //.WithProperties(wpi::StringMap(properties)) .GetEntry();
    // frc::Shuffleboard::GetTab("Test").Add("LockedOnTarget", false)
    //     .WithWidget(frc::BuiltInWidgets::kBooleanBox).GetEntry();
    // frc::Shuffleboard::GetTab("Test").Add("TxOffset", 0.0)
    //     .WithWidget(frc::BuiltInWidgets::kDial).GetEntry();
    frc::Shuffleboard::GetTab("Test").Add("ToggleSystem", tst)
        .WithWidget(frc::BuiltInWidgets::kToggleButton).GetEntry();
    frc::Shuffleboard::GetTab("Test").Add("ToggleCommand", tst)
        .WithWidget(frc::BuiltInWidgets::kCommand).GetEntry();
}
