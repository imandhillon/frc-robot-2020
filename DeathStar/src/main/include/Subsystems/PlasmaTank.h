...
std::shared_ptr<rev::CANSparkMax> loaderMotor;
std::shared_ptr<frc::AnalogInput> loadForce;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
public:
	static constexpr double kConveyorSpeed = 1.0;
	static constexpr double kLoaderSpeed = 0.9;
	...
	void RunConveyor(double speed = kConveyorSpeed);
	void StopConveyor() { RunConveyor(0.0); }

	// Run the loader
	void RunLoader(double speed = kLoaderSpeed);
