...
private:
	...
	static constexpr uint32_t MAX_DISTANCE = 1000; //change this to the maximum distance the sensor can resolve color
...
public:
	static constexpr double kColorWheelCircumference = 32 * M_PI;
