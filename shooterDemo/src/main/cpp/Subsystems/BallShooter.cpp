...
ballShooter1.reset(new rev::CANSparkMax(4,  rev::CANSparkMaxLowLevel::MotorType::kBrushless));

//AddChild("ballShooter1", ballShooter1);

//ballshooter2.reset(new frc::NidecBrushless(2, 2));
 ballShooter2.reset(new rev::CANSparkMax(6,  rev::CANSparkMaxLowLevel::MotorType::kBrushless));
